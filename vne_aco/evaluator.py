...
def load_instances(path: str, limit: int | None, offset: int = 0) -> List[Dict]:
...
def write_markdown_table(
    ...
    file_path: str,
    *,
    title: str = "ACO Results",
    dataset_info: str = "",
) -> None:
    """Write ACO evaluation metrics as a markdown table."""
    ...
    lines.extend([
        ...
        f"| ACO avg objective | {metrics['aco_avg_objective']:.4f} |",
        f"| ACO best objective | {metrics['aco_best_objective']:.4f} |",
        f"| ACO worst objective | {metrics['aco_worst_objective']:.4f} |",
