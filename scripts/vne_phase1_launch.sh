...
echo " Epochs: $EPOCHS | GPU mem: ${GPU_MEM} | BQ batch=64, LEHD batch=128/64"
echo "================================================================"
echo ""
...
# Reduced batch_size=64: BQ's unified attention over all tokens is O(seq_len²)
echo ">>> BQ-128 (seed=100)"
EXP=$(make_export "bq" "128" "8" "512" "phase1_bq128" "100" ",VNE_BATCH_SIZE=64")
...
EXP=$(make_export "bq" "192" "12" "768" "phase1_bq192" "200" ",VNE_BATCH_SIZE=64")
