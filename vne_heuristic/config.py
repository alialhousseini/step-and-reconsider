...
class HeuristicConfig:
    ...
    def __init__(self):
        ...
        # tuning.
        self.supervised_tuning_dataset_path = "./data/vne/vne_supervised_training_dataset_50k.pickle"
        ...
        # Heuristics to evaluate. Valid names are "cost_greedy",
        # "balanced_greedy", and "one_step_lookahead".
        self.heuristics = ("cost_greedy", "balanced_greedy", "one_step_lookahead")
